...
const Skills = ({ skills }: Props) => {
  ...
  return (
    <motion.div
      ...
      className="flex relative flex-col text-center md:text-left  max-w-[2000px] xl:px-10 h-screen space-y-6 justify-start lg:justify-evenly   mx-auto items-center"
    >
