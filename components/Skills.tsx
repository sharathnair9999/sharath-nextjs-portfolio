...
const Skills = ({ skills }: Props) => {
  ...
  return (
    <div className="flex relative flex-col text-center md:text-left  max-w-[2000px] xl:px-10 lg:h-screen h-fit space-y-6 justify-start lg:justify-evenly   mx-auto items-center">
